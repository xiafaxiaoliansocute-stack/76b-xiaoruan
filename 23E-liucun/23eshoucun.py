...
FIRST_DATE = "2026-07-21"

# =============================
# API地址
# =============================
USERDAY_API = "https://api6.o-9-d-4.com/api/backend/trpc/userDay.list"
EXPORT_LIST_API = "https://api6.o-9-d-4.com/api/backend/trpc/exportData.list"
DOWNLOAD_API = "https://api6.o-9-d-4.com/api/backend/trpc/exportData.download"
...
headers = {
    ...
    "x-admin-host": "admin-16028-5acf36.c-9-m-1.com",
